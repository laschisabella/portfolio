export default function Project() {
  return (
    <div className='bg-black text-gray-200 border-4 border-white outline outline-8 outline-black m-8 p-8 flex gap-12 font-roboto'>
      <div className='w-3/4'>
        <h2 className='text-lg font-bold mb-3'>Lorem Ipsum</h2>
