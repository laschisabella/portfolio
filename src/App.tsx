  ...
  return (
    <div className="flex flex-col lg:flex-row">
      ...
      <div className="lg:h-screen overflow-y-scroll lg:w-[60vw] scroll-smooth relative scrollbar-thin scrollbar-thumb-gray-600 scrollbar-track-gray-900">
        <nav className="fixed top-5 lg:top-0 left-1/2 lg:left-[70vw] -translate-x-1/2 z-10 flex gap-5 px-5 py-2 lg:px-12 lg:py-5 lg:my-10 uppercase rounded-lg select-none bg-gray-100/20 backdrop-blur-sm font-murecho justify-between">
        ...
        <div className="fixed z-10 flex gap-2 text-3xl translate-x-1/2 lg:translate-x-0 right-1/2 bottom-5 lg:bottom-10 lg:right-20">
          <a
